$(window).load(function () {
	...
	if ($('#gallery-content-center').length > 0) {
		...
		$('.project-filter-links').on('click', this, function () {
...
$(document).ready(function () {
	...
	$('#open-image').on('click', this, function (e) {
		e.preventDefault();
		$(this).ekkoLightbox();
	});
	$('#open-youtube').on('click', this, function (e) {
		e.preventDefault();
		$(this).ekkoLightbox();
	});
	...
	if ($("#map").length > 0) {
		...
		var position = [50.813881, 3.250035];
...
$('#back-top a').on('click', this, function () {
	$('body,html').animate({
		scrollTop : 0
	}, 500);
	return false;
